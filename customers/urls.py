...
urlpatterns = [
    path('daftarkan_customer/<slug:slug>/', customer_view.daftarkan_customer, name='daftarkan_customer'),
    path('daftar_customer/<slug:slug>/', customer_view.daftar_customer, name='daftar_customer'),
    ...
    path('data_ac/<slug:slug>/', customer_view.data_ac, name='data_ac'),
